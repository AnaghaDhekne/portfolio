...
const MagicButton = ({
    ...
    return (
        <button
            ...
            onClick={handleClick}
        >
            <span className={`absolute inset-[-1000%] animate-[spin_2s_linear_infinite] ${isDark
                    ? 'bg-[conic-gradient(from_90deg_at_50%_50%,#9333EA_0%,#4F46E5_50%,#9333EA_100%)]'
                    : 'bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]'
                }`} />

            <span
                className={`inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg px-4 text-sm font-medium gap-2 transition-colors duration-300 ${isDark
