...
import { FaReact, FaAws, FaChartLine, FaSync, FaFacebook, FaTwitter, FaMoneyCheckAlt, FaGithub, FaCogs, FaExchangeAlt, FaCloud, FaAndroid, FaMicrochip, FaRaspberryPi, FaTasks, FaStripeS } from "react-icons/fa";
import { FaJava } from 'react-icons/fa6';
import { GrResources } from 'react-icons/gr';
import { TbPackages } from 'react-icons/tb';
import { GiAtomicSlashes, GiProcessor } from 'react-icons/gi';
import { FcParallelTasks } from 'react-icons/fc';
import { SiTensorflow, SiKeras, SiPytorch, SiFuturelearn, SiJunit5, SiSwagger, SiPython, SiGradle, SiApachemaven, SiJupyter, SiApacheairflow, SiScikitlearn, SiOpencv, SiNumpy, SiPandas, SiHtml5, SiCss3, SiJavascript, SiFlask, SiSpringboot, SiMysql, SiTypescript, SiNextdotjs, SiTailwindcss, SiAppwrite, SiNodedotjs, SiExpress, SiPostgresql, SiPrisma, SiSpring, SiPostman, SiHibernate, SiGithub, SiSwift, SiFirebase, SiXcode, SiDjango, SiReact } from "react-icons/si";
